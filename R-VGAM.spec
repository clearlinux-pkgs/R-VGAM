...
Version  : 1.1.4
Release  : 32
URL      : https://cran.r-project.org/src/contrib/VGAM_1.1-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/VGAM_1.1-4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603467916
